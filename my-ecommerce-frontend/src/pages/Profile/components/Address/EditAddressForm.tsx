...
export const EditAddressForm = ({
  ...
  const trigger = (
    <button
      className="flex items-center text-sm text-slate-600 hover:text-slate-900 transition-colors disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:text-slate-600"
      disabled={disabled}
    >
